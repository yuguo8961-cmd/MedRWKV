...
from .modules.PositionalEncoding import FixedPositionalEncoding, LearnedPositionalEncoding
from .modules.Unet_skipconnection import Unet
...
if __name__ == "__main__":
    ...
    model = BTS(img_dim=(160, 160, 96), patch_dim=8, num_channels=4, num_classes=4,
                embedding_dim=512,
                num_heads=8,
                num_layers=4,
                hidden_dim=4096,
