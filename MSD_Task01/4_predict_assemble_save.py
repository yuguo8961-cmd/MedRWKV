...
class BraTSTrainer(Trainer):
    ...
    def define_model(self):
        ...
        model_path = "./data/3D_parameter/MedRWKV_Task01.pth"
        ...
        save_path = "./data/3D_results/Task01_BrainTumour"+"/"+file_name
        os.makedirs(save_path, exist_ok=True)
        save_visual_path = "./data/3D_visual_results/Task01_BrainTumour"+"/"+file_name
    ...
    def validation_step(self, batch):
        ...
        voxel_spacing = [1, 1, 1]
        case_name = properties['name'][0]
        raw_data_dir = "./data/MSD_Task01_BrainTumour/"
        t1_itk = os.path.join(raw_data_dir, case_name, f"img.nii.gz")
