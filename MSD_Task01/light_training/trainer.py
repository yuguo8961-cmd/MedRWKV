...
class Trainer:
    def __init__(self, env_type,
        ...
        self.num_step_per_epoch = 100 // self.num_gpus
    ...
    def validation_single_gpu(self, val_dataset,):
        ...
        print("Average Dice: TC: {}  WT: {}  ET: {}".format(v_sum[0], v_sum[1], v_sum[2]))
        print("Average Dice: {}  ".format(((v_sum[0] + v_sum[1] + v_sum[2])/len(v_sum))))
    ...
    def validation_single_gpu_two_metrics(self, val_dataset,):
        ...
        if isinstance(dice_out, list) or isinstance(dice_out, tuple) or isinstance(hd95_out, list) or isinstance(hd95_out, tuple):
            return_list = True
        ...
        print("Average Dice: TC: {}  WT: {}  ET: {}".format(dice_sum[0], dice_sum[1], dice_sum[2]))
        print("Average HD95: TC: {}  WT: {}  ET: {}".format(hd95_sum[0], hd95_sum[1], hd95_sum[2]))
        print("Average Dice: {}  ".format(((dice_sum[0] + dice_sum[1] + dice_sum[2])/len(dice_sum))))
        print("Average HD95: {}  ".format(((hd95_sum[0] + hd95_sum[1] + hd95_sum[2])/len(hd95_sum))))
